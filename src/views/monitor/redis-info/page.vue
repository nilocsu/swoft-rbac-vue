<template>
  <d2-container>
    ...
    <el-row :gutter="8">
      <el-divider orientation="left">Redis详细信息</el-divider>
...
import * as redisService from '@/api/monitor/redis'
  ...
  mounted () {
    ...
    this.timer = setInterval(() => {
      if (this.$route.path.indexOf('redis') !== -1) {
        axios.all([
          redisService.keysSize(),
          redisService.memoryInfo()
        ]).then((r) => {
